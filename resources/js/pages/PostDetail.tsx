                                        ...
                                        {module.file_url && (
                                            <>
                                                ...
                                                <a
                                                    ...
                                                    download
                                                    className="flex w-full transform items-center justify-center gap-3 rounded-full border border-amber-600 bg-transparent px-6 py-3 text-base font-bold text-amber-600 transition-all duration-300 hover:scale-[1.02] hover:bg-amber-50 sm:w-auto dark:text-amber-400 dark:hover:bg-gray-800"
                                                >
                                                    <Download size={20} />
                                                    Download
                                                </a>
                                ...
                                {recentModules && recentModules.length > 0 ? (
                                    recentModules.map((recent) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-grow">
                                                <h4 className="line-clamp-2 text-sm font-medium text-gray-900 transition-colors group-hover:text-indigo-600 dark:text-gray-200 dark:group-hover:text-indigo-400">
                                                    {recent.title}
                                                </h4>
